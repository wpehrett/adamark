...
class Module { //TODO make some extended abstract classes for PipelinedModule, FixedLatencyModule, etc., and remove those params (latency, cycleCount, maxPipeline, stalled) from the generic Module (since some may not use them).
	public:
