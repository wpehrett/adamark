...
- prototypes.cpp
- prototypes.hpp
If these get changed (in particular, if Message, ThReqParams, or Module get changed), it can easily break All of the Things.
